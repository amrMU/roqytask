...
<div class="panel panel-flat tb_padd">
    ...
    <div class="panel-heading">
        ...
        <h5 class="panel-title"> {{ trans('dash.users_list') }} </h5>
    ...
    <a class="btn btn-primary" href="{{ route('admin_create') }}"> {{ trans('dash.add_new_user') }} </a>
...
<!--                 <th class="text-center"> {{ trans('dash.image') }} </th>
 ...
 -->                <th class="text-center"> {{ trans('dash.type_user') }} </th>
                 <th class="text-center"> {{ trans('dash.permissions_groups') }} </th>
        ...
        <tbody>
            ...
            <tr id="user_{{ $user->id }}">
              ...
              <td class="text-center"> {{ @$user->admin_group->name_ar }} </td>
                ...
                <td class="text-center">
                  ...
                  <a href="{{  route('admin_delete',['id' => $user->id ]) }}" class="btn btn-danger"> <i class="icon-database-remove"></i> </a> 
                    ...
                    <div class="modal-content">
                        ...
                        <div class="thumbnail no-border no-margin">
                            ...
                            <div class="caption text-center">
                                ...
                                <h6 class="text-semibold no-margin-top content-group"> {{ $user->name }} <small class="display-block">  </small></h6>
