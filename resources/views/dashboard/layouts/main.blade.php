...
<head>
    ...
    <title>RoQaY</title>
    <link href="{{ asset('site/') }}/favicon.png" rel=icon>
    ...
    <link href="{{ asset('/') }}fonts/Droid.Arabic.Kufi.ttf" type="application/octet-stream">
    <style>
        body.* {
                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active "><a href="{{ URL::to('ar/admin/home') }}"><i class="icon-home4"></i> <span>@lang('home.dashboard')</span></a></li>
                             ...
                             <li class=" "><a href="{{ URL::to('ar/admin/albums') }}"><i class="icon-images2"></i> <span>@lang('home.album')</span></a></li>
                           
                            <li class="">
                                    <a href="#" class="has-ul legitRipple"><i class="icon-shield-check"></i> <span>@lang('home.administration_group')</span><span class="" style="left: 39.2308%; top: 63.6364%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.2s, 0.5s; width: 202.844%;"></span></a>
                                    <ul class="hidden-ul" style="display: none;">
                                      
                                       <li><a href="{{ url('ar/admin/permissions_groups') }}"> <span>{{ trans('home.administration_group') }} </span></a></li>
                                       <li><a href="{{ url('ar/admin/permissions_groups/create') }}"> <span>{{ trans('home.administration_group_create') }} </span></a></li>
