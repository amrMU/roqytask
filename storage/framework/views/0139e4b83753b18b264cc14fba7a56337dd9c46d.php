  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo e(URL::to('/admin/albums/').'/'.$album->id.'/delete'); ?>" class="btn btn-danger "> 
...
</div><?php /**PATH C:\xampp\htdocs\roqytask\resources\views/dashboard/albums/delete_from_list.blade.php ENDPATH**/ ?>