                            ...
                            <form class="form-horizontal form-validate-jquery" method="POST" action="<?php echo e(URL::to('/admin/users')); ?>" enctype='multipart/form-data'>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.name'); ?>" value="<?php echo e(Request::old('name')); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\roqytask\resources\views/dashboard/users/create.blade.php ENDPATH**/ ?>