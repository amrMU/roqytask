...
<head>
  ...
  <?php echo $__env->make('dashboard.layouts.meta_tags_social', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<script src="https://www.gstatic.com/firebasejs/3.6.10/firebase.js"></script>
     <script>
        ...
        if(Notification.permission!=='default'){
            ...
            var notify;
            // console.log(data.val().subject,data.val());
            notify= new Notification('New message from Amrmoh.com Says: '+data.val().subject,{
               ...
               var notification_length =  $('.notification_length').html();
                var length = notification_length ++;
                $('.notification_length').html(notification_length);
    ...
    <link href="<?php echo e(asset('/')); ?>fonts/Droid.Arabic.Kufi.ttf" type="application/octet-stream">
    <style>
        body.* {
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="">
									<a href="#" class="has-ul "><i class="icon-archive"></i> <span><?php echo app('translator')->getFromJson('home.expertise'); ?> / <?php echo app('translator')->getFromJson('home.services'); ?></span><span class="" style="left: 39.2308%; top: 63.6364%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.2s, 0.5s; width: 202.844%;"></span></a>
									<ul class="hidden-ul" style="display: none;">
                                        <li><a href="<?php echo e(URL::to('ar/admin/categories')); ?>" class=""><?php echo app('translator')->getFromJson('home.list'); ?></a></li>
                                        <li><a href="<?php echo e(URL::to('ar/admin/categories/create')); ?>" class=""><?php echo app('translator')->getFromJson('home.new_one'); ?></a></li>
									</ul>
                            </li>
                            <li class="">
                            ...
                            <li class="">
                             ...
                             <li class="">
                                <a href="#" class="has-ul "><i class="icon-comment-discussion position-left"></i>
                                   <span>
                                    <?php echo app('translator')->getFromJson('home.contact_us_list'); ?>
                            ...
                            <span class="" style="left: 39.2308%; top: 63.6364%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.2s, 0.5s; width: 202.844%;"></span></a>
                                <ul class="hidden-ul" style="display: none;">
                                    <li><a href="<?php echo e(URL::to('ar/admin/contact_us')); ?>" class="">
                                        <?php echo app('translator')->getFromJson('home.contact_us_list'); ?>
                                        <?php if(isset($contact_us_count) && $contact_us_count > 0 ): ?>
                                        <span class="label bg-blue " style="padding: 5px">
                                           <span class="notification_length"><?php echo e(@$contact_us_count); ?></span>
...
<?php /**PATH C:\xampp\htdocs\amrmoh.com\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>