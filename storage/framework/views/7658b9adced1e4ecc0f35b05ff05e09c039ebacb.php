        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <!-- Form validation -->
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal form-validate-jquery" method="POST" action="<?php echo e(URL::to('/admin/setting')); ?>" enctype='multipart/form-data'>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <!-- specialize ar input -->
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.specialize_ar'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        <div class="col-lg-9">
                                            <input type="text" name="specialize_ar" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>" value="<?php echo e(@$info->specialize_ar); ?>">
                                        </div>
                                    </div>
                                    <!-- /specialize ar input -->
                                    <!-- specialize en input -->
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.specialize_en'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        <div class="col-lg-9">
                                            <input type="text" name="specialize_en" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>" value="<?php echo e(@$info->specialize_en); ?>">
                                        </div>
                                    </div>
                                    <!-- /specialize en input -->
                                 ...
                                 <!-- content ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="meta_tags" class="form-control tokenfield"  value="<?php echo e(@$info->meta_tags); ?>">
                                        </div>
                                    </div>
                                    <!-- /Meta Tags input -->
                                    <!-- extirnal code input -->
                                    ...
                                    <!-- Logo uploader -->
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.resume'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>"> *</span></label>
                                        <div class="col-lg-9">
                                            <input type="file" name="cv" class="file-styled" >
                                        </div>
                                    </div>
                                    <!-- /Logo uploader -->
                                   <!-- files uploader -->
                    ...
                    <img src="<?php echo e(@url($setting->logo)); ?>" class="img-responsive" style="max-width:100%" >
                    <?php endif; ?>
                    </div>
                    <div class="col-md-2">
                    <a href="<?php echo e(@$setting->cv); ?>" target="_blank">
                    ...
                    <small class="text-center">
                        <?php echo $__env->make('dashboard.setting.external_delete_model', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </small>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amrmoh.com\resources\views/dashboard/setting/update.blade.php ENDPATH**/ ?>