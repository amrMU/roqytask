            ...
            <div class="page-header page-header-default">
                    ...
                    <div class="page-title">
                        ...
                        <?php echo app('translator')->getFromJson('home.dashboard'); ?> -
                         <span class="text-semibold"><?php echo app('translator')->getFromJson('home.expertise'); ?> - </span>
                          <span class="text-semibold"><?php echo app('translator')->getFromJson('home.create_expertis'); ?> </span>
                         </h4>
                    </div>
                ...
                <div class="breadcrumb-line">
                    ...
                    <li><a href="<?php echo e(URL::to('ar/admin/home')); ?>"><i class="icon-home2 position-left"></i> <?php echo app('translator')->getFromJson('home.home'); ?></a></li>
                        ...
                        <li class="active"><?php echo app('translator')->getFromJson('home.new_one'); ?></li>
                    </ul>
            ...
            <div class="content">
                <!-- Form validation -->
                    <div class="panel panel-flat col-md-12">
                        ...
                        <h5 class="panel-title" > <?php echo app('translator')->getFromJson('home.create_expertis'); ?> </h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <!-- content en input -->
                                       <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                        <textarea name="content_ar" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.content_ar'); ?>"><?php echo e(Request::old('content_ar')); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /content en input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                        <textarea name="content_en" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.content_en'); ?>"><?php echo e(Request::old('content_en')); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /content en input -->
                                    <!-- Meta Tags input -->
