    ...
    <div class="body_wrapper">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <button class="btn btn-gradiant">
                                <a href="<?php echo e(url('u/login')); ?>">login</a>
                            </button>
                        </li>
                        <?php else: ?>
                        <li class="nav-item">
                            <button class="btn btn-gradiant">
                                <a href="<?php echo e(url('i/profile')); ?>"><?php echo e(@Auth::user()->name); ?></a>
                            </button>
                        </li>
                         <li class="nav-item">
                            <button class="btn btn-gradiant">
                                <a href="<?php echo e(url('albums')); ?>">albums</a>
                            </button>
                        </li>
                        <?php if(Auth::user()->type_user == 'admin'): ?>
                        <li class="nav-item">
                            <button class="btn btn-gradiant">
                                <a href="<?php echo e(url('admin/home')); ?>" target="_blank">Panel</a>
                            </button>
                        </li>
                        <?php endif; ?>
                        <?php endif; ?>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <a class="navbar-brand" href="index.html"><img src="<?php echo e(asset('/site')); ?>/images/logo-m.png"
                                data-src="<?php echo e(asset('/site')); ?>/images/logo-m.png" class="lazyload"></a>
...
</html><?php /**PATH C:\xampp\htdocs\roqytask\resources\views/front/layout.blade.php ENDPATH**/ ?>