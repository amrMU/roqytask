        ...
        <?php endif; ?>
            <table class="table text-nowrap table datatable-basic" id="table">
                ...
                <tr>
                    ...
                    <td><span class="text-semibold"><?php echo e(@$user->name); ?></span></td>
                    <td><span class="text-muted"><?php echo e(@$user->email); ?></span></td>
                    <td><h6 class="text-semibold"><?php echo e(@$user->type_user); ?></h6></td>
                    <td>
                    ...
                    <td>
                    <?php echo $__env->make('dashboard.users.delete_from_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </td> 
                </tr>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\roqytask\resources\views/dashboard/users/index.blade.php ENDPATH**/ ?>