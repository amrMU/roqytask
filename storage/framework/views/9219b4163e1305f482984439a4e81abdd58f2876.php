            ...
            <div class="page-header page-header-default">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold"><?php echo app('translator')->getFromJson('home.update_info'); ?></span> - <?php echo app('translator')->getFromJson('home.dashboard'); ?></h4>
                    </div>
                ...
                <!-- Form validation -->
                    <div class="panel panel-flat col-md-10">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal form-validate-jquery" method="post" action="<?php echo e(route('permissions_edit_user',$info)); ?>" enctype='multipart/form-data'  >
                            ...
                            <input name="use" type="hidden" value="<?php echo e(@$info->id); ?>">
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.name'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        <div class="col-lg-9">
                                            <input type="text" name="name" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.name'); ?>" value="<?php echo e(@$info->name); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                 ...
                                 <!-- content ar input -->
                                    ...
                                    <!-- content en input -->
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.administration_group'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        <div class="col-lg-9"> 
                                        <select name="administration_group_id" class="form-control">
                                            <option value="null"><?php echo app('translator')->getFromJson('home.select_one'); ?></option>
                                               <?php $__currentLoopData = $adminstration_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(@$group->id); ?>" <?php if($info->administration_group_id == $group->id): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e(@$group->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        </div>
                                    </div>
                                   ...
                                   <!-- content en input -->
                                    <div class="form-group">
                                        <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.type_user'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        <div class="col-lg-9"> 
                                        <select name="type_user" class="form-control" >
                                            <option value="null"><?php echo app('translator')->getFromJson('home.select_one'); ?></option>
                                            <option value="user" <?php if($info->type_user == 'user'): ?> selected <?php endif; ?>>users</option>
                                            <option value="admin" <?php if($info->type_user == 'admin'): ?> selected <?php endif; ?>>admin</option>
                    ...
                    <!-- /form validation -->
                    <div class="col-md-2">
                    <img src="<?php echo e(asset('/').@$info->image); ?>" class="img-responsive" style="max-width:100%" >
                    </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\roqytask\resources\views/dashboard/users/edit.blade.php ENDPATH**/ ?>