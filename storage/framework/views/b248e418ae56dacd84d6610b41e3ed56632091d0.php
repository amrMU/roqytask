                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active "><a href="<?php echo e(URL::to('ar/admin/home')); ?>"><i class="icon-home4"></i> <span><?php echo app('translator')->getFromJson('home.dashboard'); ?></span></a></li>
                             ...
                             <li class=" "><a href="<?php echo e(URL::to('ar/admin/albums')); ?>"><i class="icon-images2"></i> <span><?php echo app('translator')->getFromJson('home.album'); ?></span></a></li>
                           
                            <li class="">
                                    <a href="#" class="has-ul legitRipple"><i class="icon-shield-check"></i> <span><?php echo app('translator')->getFromJson('home.administration_group'); ?></span><span class="" style="left: 39.2308%; top: 63.6364%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.2s, 0.5s; width: 202.844%;"></span></a>
                                    <ul class="hidden-ul" style="display: none;">
                                      
                                       <li><a href="<?php echo e(url('ar/admin/permissions_groups')); ?>"> <span><?php echo e(trans('home.administration_group')); ?> </span></a></li>
                                       <li><a href="<?php echo e(url('ar/admin/permissions_groups/create')); ?>"> <span><?php echo e(trans('home.administration_group_create')); ?> </span></a></li>
...
<?php /**PATH C:\xampp\htdocs\roqytask\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>