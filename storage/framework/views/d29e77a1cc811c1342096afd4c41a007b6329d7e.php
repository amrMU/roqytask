...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                ...
                <span class="text-semibold"><?php echo app('translator')->getFromJson('home.expertise_list'); ?> </span>
            </h4>
        </div>
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php echo app('translator')->getFromJson('home.expertise_list'); ?></li>
        </ul>
